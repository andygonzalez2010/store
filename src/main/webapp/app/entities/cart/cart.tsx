...
import { getEntities, reset } from './cart.reducer';
...
export type ICartState = IPaginationBaseState;
...
export class Cart extends React.Component<ICartProps, ICartState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="cart-heading">
          <Translate contentKey="storeApp.cart.home.title">Carts</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="storeApp.cart.home.createLabel">Create new Cart</Translate>
          </Link>
        </h2>
