              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('quantity')}>
                    <Translate contentKey="storeApp.order.quantity">Quantity</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="storeApp.order.cart">Cart</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="storeApp.order.item">Item</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {orderList.map((order, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{order.itemTitle ? <Link to={`item/${order.itemId}`}>{order.itemTitle}</Link> : ''}</td>
